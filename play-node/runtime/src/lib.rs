...
// use sr_primitives::traits::{self, NumberFor, BlakeTwo256, Block as BlockT, StaticLookup, Verify, ConvertInto};
use sr_primitives::weights::Weight;
use client::{
	block_builder::api::{CheckInherentsResult, InherentData, self as block_builder_api}, runtime_api as client_api, impl_runtime_apis
};
...
pub const VERSION: RuntimeVersion = RuntimeVersion {
	spec_name: create_runtime_str!("play-node"),
	impl_name: create_runtime_str!("play-node"),
	authoring_version: 3,
	spec_version: 4,
	impl_version: 4,
...
construct_runtime!(
		...
		UncheckedExtrinsic = UncheckedExtrinsic
	{
		...
		KittyConfig: kitty::{Module, Call, Storage, Event<T>, Config<T>},
	}
);
